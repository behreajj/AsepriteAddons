...
- `deleteLayer`: Deletes layers in the timeline range. Children of group layers will be unparented and appended to a range. Creates a new layer if all existing layers are deleted.
