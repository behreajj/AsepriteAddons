...
- `correctTilesets`: Checks tile set names for empty names, invalid characters in file paths, and duplicate names. Renames tile sets as needed. Offsets each base index based on the total count of tiles across all sets.
