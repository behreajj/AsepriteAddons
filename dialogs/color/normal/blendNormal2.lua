...
dlg:button {
    ...
    onclick = function()
        ...
        local mixNormal <const> = Rgb.mixNormal
        ...
        while i < lenFrames do
            ...
            while j < cLen do
                ...
                if v <= 0.0 then aClr = bClr end
                if t <= 0.0 then bClr = aClr end
                ...
                local cAlpha <const> = floor(min(max(tuv, 0.0), 1.0) * 255.0 + 0.5)
