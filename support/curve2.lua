...
function Curve2.animCircIn()
    return Curve2.new(false, { Knot2.new(
        Vec2.new(0.0, 0.0),
        Vec2.new(0.0, 0.55228),
        Vec2.new(0.0, -0.55228)), Knot2.new(
        Vec2.new(1.0, 1.0),
        Vec2.new(1.55228, 1.0),
        Vec2.new(0.44772, 1.0)) }, "Circ In")
end
...
function Curve2.animCircOut()
    return Curve2.new(false, { Knot2.new(
        Vec2.new(0.0, 0.0),
        Vec2.new(0.55228, 0.0),
        Vec2.new(-0.55228, 0.0)), Knot2.new(
        Vec2.new(1.0, 1.0),
        Vec2.new(1.0, 1.55228),
        Vec2.new(1.0, 0.44772)) }, "Circ Out")
end
...
function Curve2.animEase()
    return Curve2.new(false, { Knot2.new(
        Vec2.new(0.0, 0.0),
        Vec2.new(0.25, 0.1),
        Vec2.new(-0.25, -0.1)), Knot2.new(
        Vec2.new(1.0, 1.0),
        Vec2.new(1.75, 1.0),
        Vec2.new(0.25, 1.0)) }, "Ease")
end
...
function Curve2.animEaseIn()
    return Curve2.new(false, { Knot2.new(
        Vec2.new(0.0, 0.0),
        Vec2.new(0.42, 0.0),
        Vec2.new(-0.42, 0.0)), Knot2.new(
        Vec2.new(1.0, 1.0),
        Vec2.new(1.0, 1.0),
        Vec2.new(1.0, 1.0)) }, "Ease In")
end
...
function Curve2.animEaseOut()
    return Curve2.new(false, { Knot2.new(
        Vec2.new(0.0, 0.0),
        Vec2.new(0.0, 0.0),
        Vec2.new(0.0, 0.0)), Knot2.new(
        Vec2.new(1.0, 1.0),
        Vec2.new(1.42, 1.0),
        Vec2.new(0.58, 1.0)) }, "Ease Out")
end
...
function Curve2.animLinear()
    return Curve2.new(false, { Knot2.new(
        Vec2.new(0.0, 0.0),
        Vec2.new(0.33333, 0.33333),
        Vec2.new(-0.33333, -0.33333)), Knot2.new(
        Vec2.new(1.0, 1.0),
        Vec2.new(1.33333, 1.33333),
        Vec2.new(0.66667, 0.66667)) }, "Linear")
end
