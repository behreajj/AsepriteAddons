...
---height. Uses bilinear sampling. If the width and height are equal to
---the original, returns the source image by reference. Assumes the image is in
---RGB color mode.
---@param source Image source image
...
---@return Image
---@nodiscard
function AseUtilities.resizeImageBilinear(source, wTrg, hTrg)
    local srcSpec <const> = source.spec
    ...
    local bytesRsz <const> = Utilities.resizePixelsBilinear(
