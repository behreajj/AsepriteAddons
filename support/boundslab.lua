...
function BoundsLab.newByRef(mn, mx)
    ...
    inst.mn = mn or Lab.new(-1.0, -111.0, -111.0, -0.00001)
    inst.mx = mx or Lab.new(101.0, 111.0, 111.0, 1.00001)
    return inst
end
...
function BoundsLab.newByVal(mn, mx)
    ...
    if mn then
        ...
        inst.mn = Lab.new(-1.0, -111.0, -111.0, -0.00001)
    end
    ...
    if mx then
        ...
        inst.mx = Lab.new(101.0, 111.0, 111.0, 1.00001)
    end
...
function BoundsLab.srLab2()
    return BoundsLab.newByRef(
        Lab.new(-1.0, -111.0, -111.0, -0.00001),
        Lab.new(101.0, 111.0, 111.0, 1.00001))
end
